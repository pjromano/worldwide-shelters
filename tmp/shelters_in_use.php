        ...
        <td width="300%" colspan="3" align="left" valign="middle"><table width="950" height="281" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="70%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top" class="body_copy"><span class="header_small">Shelters In Use  </span><br /><br />
                  Worldwide Shelters has already invested more than $8 million in addressing the shelter challenge by developing transitional housing and providing more than 14,000 relief shelters around the globe. But the reality is that hundreds of thousands of such shelters are needed immediately as well as an incalculable number of additional units in the coming years.<br /><br />
                  <div class="text_center"><img src="images/shelters_in_use.jpg" /></div>
                </td>
              </tr>
            </table>
            </td>
